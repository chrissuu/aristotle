from kimina_client import KiminaClient, Infotree, Snippet
client = KiminaClient(api_url="http://localhost:80")
# client.check("#check Nat")

snippet = """import Mathlib.Tactic
open Nat
open List
...
check_response = client.check(snippet, timeout=600, infotree=Infotree.full)
check_response.analyze(1.0)
print(check_response.model_dump_json())